...
# Credit
The initial code was from PHG project (option.h and option.c, http://lsec.cc.ac.cn/phg/), a parallel library for adaptive finite element methods and adaptive finite volume methods, which has been applied in various areas. It has a flexible command line parser.
